...
update api endpoint (update user profile)
    ...
    recognized file type 
        png / jpeg / jpg / webp  (only these are allowed)
    ...
    response : incorrect file_type

        http-response-code: 400
        {
            "msg": "unsupported image file type"
        }
    response : image extends 5MB

        http-response-code: 400
        {
            "msg": "image file more than contains 5MB"
        }
    response : error file upload

        http-response-code: 400
        {
            "msg": "error when file upload"
        }
    response : no session _id
