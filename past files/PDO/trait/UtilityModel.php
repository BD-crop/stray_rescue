...
trait UtilityModel
{
    ...
    public function image_upload()
    {
        ...
        if ($_FILES['fileToUpload']['error'] !== UPLOAD_ERR_OK) {
            ...
            $array['msg'] = "Upload failed";

            exit(json_encode($array, JSON_PRETTY_PRINT));
        }

        $target_dir = __DIR__ . "/../image_upload/";

        if (! is_dir($target_dir)) {

            if (! mkdir($target_dir, 0777, true)) {

                $array['msg'] = "Failed to create upload directory";
        ...
        $global_path =
            "http://localhost/dashboard/image_upload/" .
            $local_path;
        ...
        if (
            ...
            $array['msg'] = "Failed to move uploaded file";
